    ...
    <div className="bg-white flex flex-row justify-center w-full">
      <div className="bg-white w-full max-w-[1280px] relative min-h-screen">
        ...
        <main className="pt-[120px] px-[85px] pb-10">
          ...
          {/* Page Title */}
          <Card className="w-full border-none shadow-none mb-12">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12">
              <div className="flex flex-col w-full items-start gap-[60px] relative max-w-[800px] mx-auto">
                
                {/* Question 1: Previously worked with EL RACE */}
                <FormField
                  name="previouslyWorked"
                  render={({ field }) => (
                    <FormItem className="flex flex-col items-start gap-8 relative self-stretch w-full">
                      <Label className="self-stretch [font-family:'Inter',Helvetica] font-semibold text-black text-[24px] tracking-[0] leading-[normal]">
                      ...
                      <FormControl>
                        <ToggleGroup
                          ...
                          className="flex w-full items-center gap-8 relative justify-start"
                        >
                          <ToggleGroupItem
                            value="yes"
                            className="w-[120px] h-[60px] rounded-[30px] flex items-center justify-center bg-[#d9d9d9] [font-family:'Inter',Helvetica] font-semibold text-black text-[24px] tracking-[0] leading-[normal] data-[state=on]:bg-[#151d61] data-[state=on]:text-white hover:bg-[#c9c9c9] data-[state=on]:hover:bg-[#1a2470] transition-colors"
                          >
                            yes
                          </ToggleGroupItem>
                          <ToggleGroupItem
              ...
              {/* Navigation Buttons */}
              <div className="flex items-center justify-center gap-[90px] my-16">
                <Button
                  type="button"
                  onClick={() => navigate(-1)}
                  variant="outline"
                  className="w-[138px] h-[60px] rounded-[38px] text-black text-[32px] font-medium bg-[#d9d9d9] hover:bg-gray-300 transition-colors border-[#d9d9d9]"
                >
                  Cancel
                </Button>
